Feature: Creating a new object with false post number
User should not be able to add a new object on the map with the wrong post number
...
Scenario Outline: Creating a new object
	...
	And the user enters "74000" the post number
	...
	Then the user verifies that the new object cannot be created
