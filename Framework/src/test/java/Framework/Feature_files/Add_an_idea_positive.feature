...
User should be able to add a new idea for improving the application
...
|		Sve pohvale		|		Pohvala			|	Pošalji	|		Idea submitted			|
|		Sve pohvale		|		Pohvala			|  Odustani	|	Returning to the main page 	|
|		Ima grešaka		|		Kritika			|	Pošalji	|		Idea submitted			|
|		Ima grešaka		|		Kritika			|  Odustani	|	Returning to the main page 	|